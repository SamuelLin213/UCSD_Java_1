...
public class EarthquakeCityMap extends PApplet {
	...
	private Map<String, Integer> quakeCount = new HashMap<String, Integer>();
	...
	private void addKey() {	
		...
		text("Land Quake", 60, 130);
		text("Ocean Quake", 60, 155);
	...
	private boolean isLand(PointFeature earthquake) {		
		...
		for (Marker m : countryMarkers) {
			...
			{
				if(quakeCount.containsKey((String)m.getProperty("name")))
				{
					quakeCount.put((String)m.getProperty("name"), quakeCount.get((String)m.getProperty("name")) + 1);
				}
				else
				{
					quakeCount.put((String)m.getProperty("name"), 1);
				}
				return true;
			}
		}
		...
		quakeCount.put("ocean", quakeCount.get("ocean")+1);
		return false;
	}
	...
	private void printQuakes() 
	{
		...
		for(Marker cm: countryMarkers)
		{
			...
			if(quakeCount.get(name) != null)
			{
				System.out.println(name + ": " + quakeCount.get(name));
			}			
		}
		System.out.println("OCEAN QUAKES: " + quakeCount.get("ocean"));
	}
