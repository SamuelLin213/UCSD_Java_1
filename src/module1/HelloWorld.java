...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 30, 50, 350, 500, provider);
		           // (x start, y start, width, height, provider)
		...
		// create new unfoldingmap, pass in parameters for size
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, provider);
		// add coordinates to map2
		map2.zoomAndPanTo(zoomLevel, new Location(33.9f, -117.3f));
		// call draw on map2
